...
<div class="container-fluid">
 <div class="row">
  ...
  <h4 style="padding-top: 20px;">All Food ({{ count($allFood)}} )</h4>
  ...
  <table class="table table-white">
        ...
        @foreach ($allFood as $meal)
          ...
          <td> 
              <form action="{{ route('approve-recipe', $meal->id)}}" method="POST">
               @csrf 
               @method('PUT')
               <input type="hidden" name="_method" value="PUT">
               <input type="submit" class=" btn btn-primary" style="background-color:#0000FF; color: #fff; border:none;" value="Approve">
